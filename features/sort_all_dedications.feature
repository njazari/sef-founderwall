Feature: Display Individual Dedication
  ...
  Background:
    ...
    | id | tier     | dedication     | hospital_id | donor_id | status | date            |
    | 1  | Platinum | For the kids   | 1           | 1        | true   | 03082015        |
    | 2  | Gold     | For the adults | 1           | 2        | true   | 04022014        |
    | 3  | Silver   | Go Sankara!    | 1           | 3        | false  | 10102013        |
